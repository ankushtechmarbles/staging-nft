<div class="row">
    ...
    <form wire:submit.prevent="submit" class="col-md-6 w-full d-flex flex-column justify-content-center align-items-center gap-3" >
        <h1 style="font-family: Inter,serif" class="w-full">
            <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
              <rect x="0.25" y="0.25" width="36.5" height="36.5" rx="4.75" fill="#F4B406" stroke="black" stroke-width="0.5"/>
              ...
              <path d="M27.0138 10.3785L25.8511 9.21586C25.0741 8.43882 23.7198 8.43957 22.9437 9.21586L21.5195 10.64L25.5896 14.7101L27.0138 13.286C27.4019 12.898 27.6157 12.3815 27.6157 11.8323C27.6157 11.283 27.4019 10.7666 27.0138 10.3785Z" fill="black"/>
            </svg>
            Edit "{{$project_name}}"
        </h1>
        ...
        <div class="w-100">
            ...
            <textarea type="text" class="form-control w-100 draft-edit-input" id="description" wire:model.lazy="project_description"> </textarea>
        </div>

        <div class="w-100">
            <label for="problem" class="form-label">Problem</label>
            <textarea type="text" class="form-control w-100 draft-edit-input" id="problem" wire:model.lazy="project_problem"> </textarea>
        </div>

        <div class="w-100">
            <label for="solution" class="form-label">Solution</label>
            <textarea type="text" class="form-control w-100 draft-edit-input" id="solution" wire:model.lazy="project_solution"></textarea>
        </div>

        <div class="w-100">
            <label for="utilities" class="form-label">Utilities</label>
            <textarea type="text" class="form-control w-100 draft-edit-input" id="utilities" wire:model.lazy="project_utilities"></textarea>
        </div>
{{--        members --}}
        <div class="w-100">
        ...
        <div class="w-100">
            ...
            <input disabled value="" type="text" class="form-control w-100 draft-edit-input" id="chain" wire:model.lazy="project_chain">
        </div>
